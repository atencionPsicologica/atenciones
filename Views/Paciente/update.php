        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control" id="cedula" name="cedula"
              value="<?php echo $paciente->getCedula(); ?>" readonly="false" required="true" autocomplete="off">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="nombres" name="nombres"
              value="<?php echo $paciente->getNombres(); ?>" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="apellidos" name="apellidos"
              value="<?php echo $paciente->getApellidos(); ?>" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="ocupacion" name="ocupacion"
              value="<?php echo $paciente->getOcupacion(); ?>" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="email" class="form-control" id="email" name="email"
              value="<?php echo $paciente->getEmail(); ?>" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="tposangre" name="tposangre"
              value="<?php echo $paciente->getTposangre(); ?>" required="true" autocomplete="off">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="direccion" name="direccion"
              value="<?php echo $paciente->getDireccion(); ?>" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select class="form-control" id="estcivil" name="estcivil">
              ...
              <option value="<?php echo $paciente->getEstcivil(); ?>"> <?php echo $paciente->getStringEstadoCivil(); ?>
              </option>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group input-append date" id="datePicker"
              data-date="<?php echo $paciente->getFnacimiento(); ?>" data-date-format="dd-mm-yyyy">
              <input type="date" class="form-control" name="date" required="true"
                value="<?php echo $paciente->getFnacimiento(); ?>" autocomplete="off" />
