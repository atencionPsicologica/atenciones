    ...
    <div class="container">
      <form class="form-horizontal" action='?controller=paciente&action=save' method='post' id="eventForm">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="cedula" name="cedula"
              placeholder="Ingrese la cédula del paciente" required="true" autocomplete="off" maxlength="14">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="nombres" name="nombres"
              placeholder="Ingrese los nombres del paciente" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="apellidos" name="apellidos"
              placeholder="Ingrese los apellidos del paciente" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="ocupacion" name="ocupacion"
              placeholder="Ingrese la ocupación del paciente" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="email" class="form-control" id="email" name="email" placeholder="Ingrese el email del paciente"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="tposangre" name="tposangre"
              placeholder="Ingrese el tipo de sangre del paciente" required="true" autocomplete="off">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="direccion" name="direccion"
              placeholder="Ingrese la direccion del paciente" required="true" autocomplete="off">
          </div>
        </div>
