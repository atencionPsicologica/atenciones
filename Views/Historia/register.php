	...
	<div class="card">
		<div class="card-header">
			<ul class="nav nav-tabs card-header-tabs">
				<li class="nav-item">
					<a class="nav-link active" href="#historia" data-toggle="tab">Historial</a>
				</li>
				<li class="nav-item">
						...
						<div class="container">
							<div class="form-group">
								...
								<input type="fecha" class="form-control" id="fecha" name="fecha" required="true"
									readonly="false" value="<?php echo date('Y-m-d'); ?>">
							</div>
							<div class="form-group">
								<label for="numero">Número:</label>
								<input type="numero" class="form-control" id="numero" name="numero" required="true"
									readonly="false" value="<?php echo $numeroHistoria;?>">
							</div>
							<div class="form-group">
					...
					<div class="tab-pane" id="familiares">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="4" name="descripcionfami"
								placeholder="Ingrese alguna información adicional"></textarea>
						</div>
					</div>
					<div class="tab-pane" id="personales">
						...
						<div class="form-group">
							<div class="col-xs-4">
								...
								<input type="number" class="form-control" id="embarazo" name="embarazo" value="0"
									placeholder="Número de embarazos" autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-4">
								...
								<input type="number" class="form-control" id="abortos" name="abortos" value="0"
									placeholder="Número de abortos" autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-4">
								...
								<input type="number" class="form-control" id="abusoPsico" name="abusoPsico" value="0"
									autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-4">
								...
								<input type="number" class="form-control" id="abusoFis" name="abusoFis" value="0"
									autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-4">
								...
								<input type="number" class="form-control" id="abandono" name="abandono" value="0"
									autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-4">
								...
								<input type="number" class="form-control" id="vicio" name="vicio" value="0"
									autocomplete="off">
							</div>
						</div>
						...
						<div class="form-group ">
							<label for="descripcion">Descripción:</label>
							<textarea class="form-control" name="descripcionper"
								placeholder="Ingrese alguna información adicional" autocomplete="off"></textarea>
						</div>
					</div>
